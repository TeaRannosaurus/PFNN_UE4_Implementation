 ...
 */
class SURVIVALGAME_API DEPRICATED_PhaseFunctionNeuralNetwork
{
public:
	DEPRICATED_PhaseFunctionNeuralNetwork(const int arg_PFNNMode);
	~DEPRICATED_PhaseFunctionNeuralNetwork();
