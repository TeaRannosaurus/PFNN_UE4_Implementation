...
PhaseFunctionNeuralNetwork::PhaseFunctionNeuralNetwork(const int arg_PFNNMode): mode(arg_PFNNMode)
{
...
void PhaseFunctionNeuralNetwork::LoadNetworkData()
{
...
void PhaseFunctionNeuralNetwork::LoadWeights(Eigen::ArrayXXf& arg_A, const int arg_Rows, const int arg_Cols, const FString arg_FileName, ...)
{
...
void PhaseFunctionNeuralNetwork::LoadWeights(Eigen::ArrayXf& arg_V, const int arg_Items, const FString arg_FileName, ...)
{
	IPlatformFile& PlatformFile = FPlatformFileManager::Get().GetPlatformFile();
...
void PhaseFunctionNeuralNetwork::ELU(Eigen::ArrayXf& arg_X)
{
	arg_X = arg_X.max(0) + arg_X.min(0).exp() - 1;
}

void PhaseFunctionNeuralNetwork::Linear(Eigen::ArrayXf& arg_Out, const Eigen::ArrayXf& arg_Y0, const Eigen::ArrayXf& arg_Y1, float arg_MU)
{
	arg_Out = (1.0f - arg_MU) * arg_Y0 + (arg_MU) * arg_Y1;
}
void PhaseFunctionNeuralNetwork::Linear(Eigen::ArrayXXf& arg_Out, const Eigen::ArrayXXf& arg_Y0, const Eigen::ArrayXXf& arg_Y1, float arg_MU)
{
	arg_Out = (1.0f - arg_MU) * arg_Y0 + (arg_MU) * arg_Y1;
}

void PhaseFunctionNeuralNetwork::Cubic(Eigen::ArrayXf& arg_Out, const Eigen::ArrayXf& arg_Y0, const Eigen::ArrayXf& arg_Y1, const Eigen::ArrayXf& arg_Y2, const Eigen::ArrayXf& arg_Y3, float arg_MU)
{
	arg_Out = (
...
void PhaseFunctionNeuralNetwork::Cubic(Eigen::ArrayXXf& arg_Out, const Eigen::ArrayXXf& arg_Y0, const Eigen::ArrayXXf& arg_Y1, const Eigen::ArrayXXf& arg_Y2, const Eigen::ArrayXXf& arg_Y3, float arg_MU)
{
	arg_Out = (
		(-0.5 * arg_Y0 + 1.5 * arg_Y1 - 1.5 * arg_Y2 + 0.5 * arg_Y3) * arg_MU * arg_MU * arg_MU +
		(arg_Y0 - 2.5 * arg_Y1 + 2.0 * arg_Y2 - 0.5 * arg_Y3) * arg_MU * arg_MU +
